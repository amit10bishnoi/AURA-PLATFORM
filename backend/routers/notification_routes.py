...
DEMO_NOTIFICATIONS = [
    ...
    {"title":"GDPR Framework Updated","message":"GDPR Article 25 requirements have been updated. Review your current controls for compliance gaps.","type":"INFO","category":"Compliance","action_url":"/compliance","action_label":"Review Controls","is_read":True,"created_at":(now-timedelta(days=2)).isoformat()},
