...
RISK_REGISTER = [
    ...
    {"id":"RISK-007","title":"Customer consent withdrawal mechanism missing","category":"Regulatory","likelihood":4,"impact":5,"inherent_score":20,"residual_score":20,"treatment":"MITIGATE","owner":"Product","status":"OPEN","financial_impact_inr":2500000000,"framework_refs":["DPDP Section 6","GDPR Art.7"],"created_at":(datetime.utcnow()-timedelta(days=15)).isoformat(),"due_date":(datetime.utcnow()+timedelta(days=45)).isoformat()},
